...
// Si es un 1 es obligatorio, si es un 0 no lo es
 //ultima modificacion:24/11/2017.
 //autor:Rodrigo
function comprobarTexto($cadena,$maxTamanio,$minTamanio,$obligatorio){
    ...
    if(!preg_match($patron_texto, $cadena)){
        $correcto.=" tiene que ser una cadena de texto";
    }
...
//devuelve la hora formateada.tiene formato 24Horas.
//autor:Lucia.
function horaActual(){ 
     ...
     //valida numeros de telefono tanto mobiles como fijo
    //autor:Lucia
